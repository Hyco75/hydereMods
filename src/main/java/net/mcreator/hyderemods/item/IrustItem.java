...
public class IrustItem extends HyderemodsModElements.ModElement {
	@ObjectHolder("hyderemods:irust")
	public static final Item block = null;

	public IrustItem(HyderemodsModElements instance) {
		super(instance, 13);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(7).rarity(Rarity.COMMON));
			setRegistryName("irust");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Une arme tranchante utilis\uFFFDe par les fermier du coin"));
		}
	}
}
